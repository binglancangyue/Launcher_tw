...
//    public static final String SYSTEM_UI_KEY = "key_type";
    ...
    public static final boolean IS_SUPPORT_COPY_FILE = false;//是否拷贝文件(kd003数据)
